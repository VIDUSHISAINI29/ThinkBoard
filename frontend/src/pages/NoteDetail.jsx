    ...
    <div className="min-h-screen bg-base-200">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="card flex flex-col justify-center align-middle bg-base-100">
            <div className="card-body">
              <div className="form-control flex flex-col align-middle mb-4">
                <label className="label">
                  <span className="label-text text-[#3a24bc] font-medium">Title</span>
                </label>
                <input
                  type="text"
              ...
              <div className="form-control flex flex-col align-middle mb-4">
                <label className="label">
                  <span className="label-text text-[#3a24bc] font-medium">Content</span>
                </label>
                <textarea
